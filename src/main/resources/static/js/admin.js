let index = {
    init: function(){
        ...
        $("#btn-admin-report-search").on("click", ()=>{
            this.reportSearch();
        });
    },
    ...
    noticeSearch: function() {
        ...
        $.ajax({
            type: "GET",
            url: `/admin/dashboard?noticeKeyword=${noticeKeyword}`,
            contentType: "application/json; charset=utf-8",
            dataType: "json"
        }).always(function(resp) {
            console.log("HTTP Status Code: " + resp.status);
    ...
    noticeSearch: function() {
        let noticeKeyword = $("#reportKeyword").text();

        $.ajax({
            type: "GET",
            url: `/admin/dashboard?reportKeyword=${reportKeyword}`,
            contentType: "application/json; charset=utf-8",
            dataType: "json"
        }).always(function(resp) {
            console.log("HTTP Status Code: " + resp.status);
